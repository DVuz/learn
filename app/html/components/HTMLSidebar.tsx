          ...
          <>
            <CardHeader className="pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-sm text-gray-900">HTML Course Content</h3>
              </div>
            </CardHeader>
                    ...
                    <div key={sectionIndex} className="space-y-2">
                      ...
                      <ul className="space-y-1 pl-2">
                        {section.lessons.map(lesson => (
                          <li key={lesson.id}>
                            <Link
                              href={`/html/${lesson.id === 'introduction' ? '' : lesson.id}`}
                              className={`block px-3 py-2 rounded-lg text-xs transition-all hover:bg-orange-50 ${
                                currentLesson === lesson.title
                                  ? 'bg-orange-100 text-orange-700 font-medium border-l-3 border-orange-500 shadow-sm'
